...
interface ServicesContextType {
  ...
  toggleServiceStatus: (serviceId: number) => Promise<void>;
...
export const ServicesProvider = ({ children }: ServicesProviderProps) => {
  ...
  const createService = async (
    ...
    setServices((currentServices) =>
      [...currentServices, newService].sort((a, b) =>
  ...
  const updateService = async (
    ...
    setServices((currentServices) =>
      currentServices
        .map((service) => (service.id === serviceId ? updatedService : service))
...
export const useServices = () => {
  ...
  if (!context) {
    throw new Error("useServices debe utilizarse dentro de ServicesProvider");
  }
